...
- **Tag:** `ghcr.io/dioderobot/kicad:9.0.8-trixie-full`
- **KiCad:** 9.0.8 compiled from source
- **Size:** ~3GB
...
### Problem
KiCad GLB exports from official Docker containers (`kicad/kicad:9.0.8-full`) show greyed-out models with no component colors.
...
|-------|---------|------|-----------|--------|
| `kicad/kicad:9.0.8-full` | Debian Bookworm | 7.6.3 | 4 | ❌ Grey |
| `ghcr.io/dioderobot/kicad:9.0.3-ubuntu-25.10` | Ubuntu 25.10 | 7.8.1 | 19 | ✅ Full color |
| `ghcr.io/dioderobot/kicad:9.0.8-trixie-full` | Debian Trixie | 7.8.1 | 20 | ✅ Full color |
...
```bash
docker build --build-arg include_3d=true --build-arg KICAD_VERSION=9.0.8 -t kicad:trixie .
```
